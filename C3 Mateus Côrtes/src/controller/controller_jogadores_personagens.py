...
class Controller_Jogador_Personagem:
    ...
    def inserir_jogador_personagem(self) -> JogadorPersonagem:
        ...
        if self.verifica_existencia_jogador_personagem(id_jogador=id_jogador, id_personagem=id_personagem):
            ...
            self.mongo.db["jogadores_personagens"].insert_one({"id_classificacao": id_classificacao, "id_jogador": id_jogador, "id_personagem": id_personagem, "pontuacao": pontuacao})
    ...
    def atualizar_jogador_personagem(self) -> JogadorPersonagem:
        ...
        id_classificacao = int(jogador_personagem.get_id_classificacao())
        ...
        if not self.verifica_existencia_jogador_personagem(id_jogador=id_jogador, id_personagem=id_personagem):
            ...
            if opcao == 1:
                ...
                novo_id_jogador = int(id_jogador)
                jogador = jogador
            ...
            if opcao == 1:
                ...
                novo_id_personagem = int(id_personagem)
            ...
            if self.verifica_existencia_jogador_personagem(id_jogador=novo_id_jogador, id_personagem=novo_id_personagem):
                ...
                novo_id_jogador = int(jogador.get_id_jogador())
                novo_id_personagem = int(personagem.get_id_personagem())
                
                self.mongo.db["jogador_personagem"].update_one({"id_classificacao": id_classificacao}, {"$set": {"id_jogador": novo_id_jogador, "id_personagem": novo_id_personagem, "pontuacao": nova_pontuacao}})
    ...
    def valida_jogador(self, id_jogador:int=None) -> Jogador:
        if self.ctrl_jogador.verifica_existencia_jogador(id_jogador=id_jogador, external=True):
            ...
            df_jogador = self.ctrl_jogador.recupera_jogador(id_jogador=id_jogador, external=True)
